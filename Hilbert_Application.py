...
app.layout = html.Div(children=[
    ...
    # Upload Button for input of csv file
    html.Div(dcc.Upload(
        id='upload-data',
        children=html.Div([
            'Drag and Drop or ',
    ...
    # Display Columns Control Dropdown
    html.Div(children = [
    ...
    # Plot Area for PCP Graph
    html.Div(dcc.Graph(id='PCP'),style={'display': 'inline-block'}),

    # Plot Area for SPLOM Graph
    html.Div(dcc.Graph(id='SPLOM'),style={'display': 'inline-block'}),

    # Div element to show contents of the Dataframe in Table form
...
#This function reads data uploaded into the application using Upload Button
...
# Callback to store data in hidden div
...
# Callback to show all columns in color dropdowm menu
@app.callback(
...
# Callback for generation of figure of SPLOM Graph
...
# Callback for generation of figure of PCP Graph
...
# Callback for generation of Table consisting of entire data in the Dataframe
